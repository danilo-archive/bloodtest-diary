    ...
    return(
        <Menu id={props.id} style={{position: "absolute", zIndex: "4"}}>
           ...
           <Submenu label="Patient color">
             ...
             <Item  onClick={() => {serverConnect.changePatientColour(props.patientNo, "white", res => {return})}}>Remove color</Item>
           </Submenu>
           <Submenu label="Test color">
             <Submenu label="Choose color">
                <ColorPicker id={props.testId} type={"test"}/>
             </Submenu>
             <Item onClick={() => {serverConnect.changeTestColour(props.testId, "white", res => {return})}}>Remove color</Item>
           </Submenu>
